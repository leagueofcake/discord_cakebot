...
_redirect_example = 'Redirects message to #alt: !redirect #alt Hi guys, from the main channel!'
...
help_entries = {
    ...
    'redirect':     HelpEntry('!redirect', _redirect_desc, _redirect_usage, 'general', _redirect_example),
