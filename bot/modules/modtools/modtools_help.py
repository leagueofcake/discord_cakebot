...
_purge_desc = (
    "Purges a given amount of messages from the current channel. Can purge up to 100 "
    "messages."
)
_purge_usage = (
    "!purge <number> - purges <number> of messages in the current channel. Requires manage_guild "
    "permission.\n"
...
_del_desc = (
    "Deletes your previous message(s). Searches up to the previous 500 messages in the "
...
help_entries = {
    "logchannel": HelpEntry(
        "!logchannel", _logchannel_desc, _logchannel_usage, "modtools"
    ),
