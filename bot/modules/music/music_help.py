...
_playalbum_example = (
    "Play album named snow halation: !playalbum snow halation, then !yes"
)
...
help_entries = {
    "musicprefix": HelpEntry(
        "!musicprefix", _musicpre_desc, _musicpre_usage, "music", _musicpre_example
    ),
    "search": HelpEntry(
        "!search", _search_desc, _search_usage, "general", _search_example
    ),
    "play": HelpEntry("!play", _play_desc, _play_usage, "music", _play_example),
    "playid": HelpEntry(
        "!playid", _playid_desc, _playid_usage, "music", _playid_example
    ),
    "playalbum": HelpEntry(
        "!playalbum", _playalbum_desc, _playalbum_usage, "music", _playalbum_example
    ),
